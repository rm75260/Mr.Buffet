package com.diow.mrbuffet.adapter;
...
public class PostagemAdapter extends RecyclerView.Adapter<PostagemAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            textNome = itemView.findViewById(R.id.nomeBuffet);
            imagePostagem = itemView.findViewById(R.id.imageBuffet);
            textPostagem = itemView.findViewById(R.id.descricaoBuffet);
